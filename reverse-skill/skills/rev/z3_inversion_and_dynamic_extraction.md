# REV Playbook: Z3 Inversion And Dynamic Extraction

## 1. Overview & Signatures
- **Classification**: Advanced / Novel Primitive (REV)
- **Discovered In**: Challenge `collector` (2026-09-02)
- **Key Indicators**: High complexity, non-standard constraints, custom sandbox/runtime.

---

## 2. Vulnerability Mechanism & Root Cause
Novel exploit primitive and mitigation bypass.
...
- [2026-09-02 | REV | collector](../../skills/field-journal/2026-09-02_collector_postmortem.md)
